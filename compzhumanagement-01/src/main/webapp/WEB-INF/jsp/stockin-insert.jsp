...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/order-insert.css">
<style type="text/css">
.onError {
	background: url("${pageContext.request.contextPath}/images/error.gif")
		no-repeat left;
	text-indent: 20px;
...
.onSuccess {
	background: url("${pageContext.request.contextPath}/images/success.gif")
		no-repeat left;
	text-indent: 20px;
	color: green;
	display: inline-block;
...
<div class="all">
<div class="level"><img
	src="${pageContext.request.contextPath}/images/house.png">
<div class="txt">&nbsp;首页&nbsp;&gt;&nbsp;进货管理&nbsp;&gt;&nbsp;进货单&nbsp;&gt;&nbsp;新增</div>
</div>

<div class="content">
<form action="/stockIn/insertStockin" method="post" id="form">
	<table>
		<tr>
...
<tr>
                    ...
                    <td class="edit"><select name="merchandiseid.mid" id="goodsname">
	<c:forEach items="${Om}" var="Om">
		<option value="${Om.mid} ">${Om.mname}</option>
	</c:forEach>
</select></td></tr>
<tr>
                    <td class="title">经 &nbsp;办 &nbsp;人:</td> 
                    <td class="edit"><select name="employeeid.eid" id="employeename">
...
<tr>
                    ...
                    <td class="edit"><input type="text" class="txt" name="amount"></td></tr>
<tr>
                    <td class="title">商品价格:</td>
                    <td class="edit"><input type="text" class="txt" name="sprice"></td></tr>
<tr>
                    <td class="title">进货时间:</td> 
                    <td class="edit"><input type="text" class="txt" name="stockindate"  onClick="WdatePicker()"></td></tr></table><br>
