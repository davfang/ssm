...
<div class="content">
<form action="/Orders/updateOrdersByKey?or=${ord.oid}" method="post">
<table>
                <tr>
                    <td class="title">
订&nbsp;单&nbsp;编&nbsp;号</td>
 <td class="edit">
<input type="text" class="txt" name="oid" value="${ord.oid}" readonly="readonly"></td></tr>
<tr>
...
<c:forEach items="${Om}" var="Om1">
    <option value="${Om1.mid}" <c:if test="${Om1.mid eq ord.merchandiseid.mid}">selected</c:if> >${Om1.mname}</option>
 </c:forEach>
</select></td></tr>
<tr>
...
<c:forEach items="${Oe}" var="Oe1">
    <option value="${Oe1.eid}" <c:if test="${Oe1.eid eq ord.employeeid.eid}">selected</c:if> >${Oe1.ename}</option>
 </c:forEach>
</select></td></tr>
<tr>
	...
	name="merchandisenumber" value="${ord.merchandisenumber}"></td></tr>
<tr>
                    <td class="title">订&nbsp;单&nbsp;时&nbsp;间</td> 
                    <td class="edit"><input type="text" class="txt"
	name="orderdata" value="${ord.orderdata}"  onClick="WdatePicker()"></td></tr></table><br>
